    ...
    >
      <div className="w-full flex flex-col gap-3 items-center justify-center">
        ...
        <div className="mx-auto relative flex justify-center gap-4 w-[110px] sm:w-[150px]   bg-gradient-to-r from-pink-500 to-yellow-500 text-white   rounded-full font-bold">
          <button
            className="justify-center h-[30px]  gap-4 w-full bg-gradient-to-r px-1 from-sky-400 to-indigo-500 text-white   rounded-full font-bold"
            disabled={isLoading}
            type="submit"
          >
            {isLoading ? <MiniSpinner colorSpinner="indigo-600" /> : "update"}
          </button>
        </div>
      </div>
    </form>
